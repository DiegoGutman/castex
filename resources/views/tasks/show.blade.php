    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 offset-md-2">
                ...
                <hr>
                <div class="fb-comments" data-href="{{ secure_url('tasks', [$task->id]) }}" data-numposts="5"></div>
            </div>
        </div>
    </div>
@endsection
...
@section('scripts')
    ...
    <script>(function(d, s, id) {
            ...
            js.src = 'https://connect.facebook.net/es_LA/sdk.js#xfbml=1&version=v3.0&appId=865786503609640&autoLogAppEvents=1';
